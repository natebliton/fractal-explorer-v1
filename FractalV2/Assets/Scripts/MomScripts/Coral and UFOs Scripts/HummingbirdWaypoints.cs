...
public class HummingbirdWaypoints : MonoBehaviour
{
    ...
    [SerializeField] private float leave = 20f;
    ...
    void Update()
    {
        ...
        if (timer > delayStart && currentWaypointIndex == 0)
        {
            FollowPath();
        }
        if (timer > delayStart + leave && currentWaypointIndex == 1)
        {
            FollowPath();
        }
